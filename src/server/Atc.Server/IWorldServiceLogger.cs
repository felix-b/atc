...
{
    public interface IWorldServiceLogger
    {
    ...
    public class WorldServiceLogger : IWorldServiceLogger
    {
        ...
        private static readonly string _s_trafficQueryObserverConnectionNotActive = "WorldService.TrafficQueryObserverConnectionNotActive";
        private static readonly string _s_trafficQueryObserverPushingNotifications = "WorldService.TrafficQueryObserverPushingNotifications";
        ...
        public WorldServiceLogger(LogWriter writer)
        {
            _writer = writer;
        }
